"""
Django settings for logsearch project.
...
SECRET_KEY = "django-insecure-gah#_x$h5nv0j2v309(b-e-+_v8@ol%o#15!0ayejh-bhrji2w"
...
MEDIA_URL = "/media/"
MEDIA_ROOT = os.path.join(BASE_DIR, "data", "process_logs")
